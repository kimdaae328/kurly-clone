  ...
  return (
    <div>
      <div className={styles.productImg} style={{ height }}>
        <img src="https://res.cloudinary.com/dpr8m7xge/image/upload/v1715842349/p3lqjm0gpxswunqns66o.jpg" alt="" style={{ height: 'auto' }} />
      </div>
      ...
      <div className={styles.productInfo}>
        ...
        <div className={styles.productPrice}>
          <span className={styles.dimmedPrice}>13,000원</span>
          <div className={styles.discount}>
            <span className={styles.discountRate}>10%</span>
            <span className={styles.salesPrice}>11,700원</span>
          </div>
          <div className={styles.reviewCount}>
            ...
            <span className={styles.reviewNum}>9,999+</span>
          </div>
        </div>
      </div>
    </div>
